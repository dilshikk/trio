...
// Hash password with scrypt (Node built-in, no dependencies)
...
function verifyPassword(password, stored) {
  // Support plain text for easy setup (if no colon separator)
  if (!stored.includes(":")) {
...
// Helper: generate a hash (run once to create ADMIN_PASSWORD value)
// node -e "import('./index.js')" -- not needed, use the route below
app.get("/api/hash/:password", (req, res) => {
  // Only works if no JWT_SECRET set (setup mode)
