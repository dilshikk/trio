  ...
  return (
    <motion.div
      ...
      style={{
        ...
        width: size,
        height: size,
        background: "linear-gradient(135deg, #6395ff40, #a78bfa40)",
      }}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {particles.map((x, i) => (
          <FloatingParticle key={x} x={x} delay={i * 0.4} size={3 + (i % 4) * 2} />
        ))}
      </div>
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(rgba(99,149,255,1) 1px, transparent 1px), linear-gradient(90deg, rgba(99,149,255,1) 1px, transparent 1px)",
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: "linear-gradient(135deg, rgba(99,149,255,0.5), rgba(167,139,250,0.3), rgba(244,114,182,0.3))",
            }}
          />

          <div
            className="relative rounded-2xl p-8 space-y-7"
            style={{ background: "oklch(0.09 0 0 / 0.95)", backdropFilter: "blur(20px)" }}
          >
            {/* Logo */}
            <motion.div
            ...
            >
              <div className="relative">
                <motion.div
                  ...
                  style={{ background: "linear-gradient(135deg, #6395ff, #a78bfa)" }}
              ...
              <div className="text-center">
                ...
                <p className="text-white/30 text-xs mt-1 flex items-center justify-center gap-1">
                  <Shield className="w-3 h-3" /> Защищенный доступ
                </p>
              </div>
            </motion.div>
              ...
              >
                ...
                <div className="relative group">
                  <input
                    ...
                    placeholder="admin@triogroups.uz"
                    required
                    autoComplete="email"
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-white placeholder:text-white/20 outline-none transition-all duration-300 focus:border-[#6395ff]/60 focus:bg-white/8"
                  />
              ...
              >
                ...
                <div className="relative group">
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 pr-11 text-sm text-white placeholder:text-white/20 outline-none transition-all duration-300 focus:border-[#a78bfa]/60 focus:bg-white/8"
                  />
                  <button
                    type="button"
        ...
        <motion.p
          ...
          className="text-center text-[10px] text-white/20 mt-6 tracking-wider"
        >
          MADE IN{" "}
          <a
            href="https://dscreative.uz"
            target="_blank"
            rel="noopener noreferrer"
            className="text-white/40 hover:text-[#6395ff] transition-colors duration-300 font-semibold tracking-[0.1em]"
          >
            DS CREATIVE
          </a>
        </motion.p>
